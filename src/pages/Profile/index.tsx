...
import {ActivitiesContainer, ActivitiesText, Container} from './styles';
...
const Profile = () => {
  ...
  const [following, setFollowing] = useState<IFollowingUsers>({
    followingCount: 0,
    followingUsers: [],
  });
  const [followers, setFollowers] = useState<IFollowerUsers>({
    followersCount: 0,
    followerUsers: [],
  });
